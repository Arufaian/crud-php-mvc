        ...
        <div class="content-wrapper">
            ...
            <div class="page-header mb-4">
                <div class="row align-items-center">
                    <div class="col">
                        <h1 class="h3 mb-1">Tambah SPP Baru</h1>
                        <p class="text-muted mb-0">Buat data SPP baru dalam sistem.</p>
                    </div>
                    <div class="col-auto">
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <form method="POST" action="index.php?controller=spp&action=create">
                                <div class="mb-3">
