...
-- FIXED: tabel_siswa references master tables (kelas, spp), not transaction table (pembayaran)
--
...
ALTER TABLE `tabel_siswa`
  ...
  ADD CONSTRAINT `tabel_spp_idSpp` FOREIGN KEY (`id_spp`) REFERENCES `tabel_spp` (`id_spp`);

--
-- Constraints for table `tabel_pembayaran`
-- FIXED: tabel_pembayaran references tabel_siswa (correct direction: transaction -> master)
--

ALTER TABLE `tabel_pembayaran`
  ADD CONSTRAINT `pembayaran_nisn_siswa` FOREIGN KEY (`nisn`) REFERENCES `tabel_siswa` (`nisn`),
  ADD CONSTRAINT `pembayaran_idSpp_siswa` FOREIGN KEY (`id_spp`) REFERENCES `tabel_spp` (`id_spp`);
COMMIT;
